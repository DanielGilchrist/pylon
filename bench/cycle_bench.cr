...
left = Pylon::Session::LocalEndpoint.new(local_root, ignores)
right = Pylon::Session::LocalEndpoint.new(remote_root, ignores)
left.accelerate!
right.accelerate!

session = Pylon::Session::Session.new(left, right)
